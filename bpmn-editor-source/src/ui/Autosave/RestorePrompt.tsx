...
export function RestorePrompt() {
  ...
  const handleRestore = async () => {
    ...
    setStatus("hidden");
    showToast(ok ? "Automatisch gesicherter Stand wiederhergestellt" : "Wiederherstellen fehlgeschlagen", ok ? "success" : "error");
  };
  ...
  const handleDiscard = async () => {
    await clearAutosave();
    setStatus("hidden");
    showToast("Automatisch gesicherter Stand verworfen", "info");
  };
