...
import { TASK_SIZE, RECTANGLE_PORTS, BPMN_COLORS, resolveFill, resolveStroke, resolveStrokeWidth, resolveDashArray } from "./constants";
  ...
  return (
    <g transform={`translate(${shape.position.x} ${shape.position.y})`}>
      <rect
        ...
        rx={8}
        fill={resolveFill(shape, BPMN_COLORS.taskFill)}
        stroke={stroke}
