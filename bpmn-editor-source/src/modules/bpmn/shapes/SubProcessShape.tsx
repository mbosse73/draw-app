...
import { RECTANGLE_PORTS, BPMN_COLORS, resolveFill, resolveStroke, resolveStrokeWidth, resolveDashArray } from "./constants";
  ...
  return (
    <g transform={`translate(${shape.position.x} ${shape.position.y})`}>
      <rect
        ...
        height={h}
        rx={8}
        fill={resolveFill(shape, isExpanded ? "#ffffff" : BPMN_COLORS.taskFill)}
        stroke={stroke}
